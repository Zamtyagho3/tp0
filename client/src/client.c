...
int main(void)
{
	...
	log_info(logger, "Grrrande, Grrrande");
...
do {
    ...
    leido = readline("Empieza a escribir acá: ¡<--! :  "); 
    
    // Verificar si readline falló (Ctrl+D) o entrada vacía
    ...
    free(leido); // Siempre liberar memoria
